...
\begin{figure}
  ...
  \caption{Gravitational event GW150914 as detected by Omicron. Time-frequency maps with SNR values are displayed in the left column and maps with amplitude values are displayed in the right column. The first 5 rows show maps for single $Q$ values. The last row presents the combined map.}
