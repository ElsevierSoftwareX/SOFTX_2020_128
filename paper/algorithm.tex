...
To optimize the processing, the phase shift of $\pi$ is computed only a single time, when the window is constructed (see Sec.~\ref{sec:algorithm:window}). The window expression given in Eq.~\ref{eq:dbisquare2} is modified such as
\begin{equation}
  \tilde{w}_{ql}^*[k] =
  \begin{cases}
...
\begin{figure}
  \center
  \epsfig{width=7.5cm, file=./figures/gw150914_q0.eps} \epsfig{width=7.5cm, file=./figures/gw150914_q1.eps} \\
  \epsfig{width=7.5cm, file=./figures/gw150914_q2.eps} \epsfig{width=7.5cm, file=./figures/gw150914_q3.eps} \\
  \epsfig{width=7.5cm, file=./figures/gw150914_q4.eps} \epsfig{width=7.5cm, file=./figures/gw150914_full.eps}
  \caption{maps}
...
\begin{figure}
  \center
  \epsfig{width=7.5cm, file=./figures/gw150914amp_q0.eps} \epsfig{width=7.5cm, file=./figures/gw150914amp_q1.eps} \\
  \epsfig{width=7.5cm, file=./figures/gw150914amp_q2.eps} \epsfig{width=7.5cm, file=./figures/gw150914amp_q3.eps} \\
  \epsfig{width=7.5cm, file=./figures/gw150914amp_q4.eps} \epsfig{width=7.5cm, file=./figures/gw150914amp_full.eps}
  \caption{maps}
