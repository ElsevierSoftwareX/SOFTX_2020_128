...
The chunk data vector is first transformed to optimize the performance of the subsequent processing. It is down-sampled to a working frequency to maximize the processing speed and it is high-pass filtered to reduce the signal dynamic range.
